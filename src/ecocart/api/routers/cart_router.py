...
from src.ecocart.database import get_total_bill, get_all_billed_items, clear_bill, remove_item_from_bill
from fastapi.templating import Jinja2Templates

router = APIRouter()

templates = Jinja2Templates(directory="/home/himanshu/projects/walmart/src/ecocart/api/templates")
